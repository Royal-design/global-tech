import shopBanner from "../assets/banner/banner03.jpg";
...
export const ShopBanner = () => {
  ...
  return (
    <div>
      <div className="w-full h-[26rem] bg-gray-400 shop-container">
        <Swiper
          autoplay={{ delay: 4000 }}
          ...
          {data.map((data, i) => (
            <SwiperSlide key={i}>
              <div className="flex justify-between w-full h-full">
                <div className="banner-content pt-2 px-6 font-rajdhani dark:bg-[#211801] bg-[#fff6ed] max-sm:w-[60%] max-md:w-[60%] w-[40%]">
